  ...
  return (
    ...
    >
      <div
        ...
        className="pointer-events-auto flex items-center gap-0.5 rounded-full border border-white/10 bg-surface-overlay/90 p-1 shadow-[0_8px_30px_-4px_rgba(0,0,0,0.6)] backdrop-blur-md"
      >
